	...
	ui(new Ui::frmAnimationButton)
{
    ...
    QString qss = "color:#BECEC6;"
                  "background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 #1B3152,stop:1 #255C80);";
    ...
    connect(ui->widget1,SIGNAL(clicked()),this,SLOT(slot_switchbutton()));
...
void frmAnimationButton::slot_switchbutton()
{
    qDebug()<<"点击按钮";
}
